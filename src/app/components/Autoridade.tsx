    ...
    <main className="p-6 max-w-md mx-auto bg-black rounded-lg shadow-lg mt-10 text-white font-sans">
      {etapa === 1 && (
        <>
          ...
          <button
            onClick={prosseguir}
            className="w-full mt-8 bg-gradient-to-r from-red-600 via-orange-500 to-yellow-400 text-black py-3 rounded-lg font-bold hover:brightness-110 transition duration-300"
          >
            Prosseguir ➜
          </button>
        </>
